...
public:
    ...
    */
    void moveN(int steps)
    {
        ...
        for (step = 100; step >= steps; step = step - 1) // outra forma de repetir
        {
    ...
    */
    ...
    void pickBeepers(int nBeepers)
    {
        // Não existir um marcador
        if (nextToABeeper())
        {
            for (int contador = 6; contador > 0; contador = contador - 1)
            {
                // pegar nBeepers
                pickBeeper();
            }
...
int main()
{
    ...
    robot->pickBeeper();*/
    robot->faceNorth();
    robot->move(); // começa a sair do X
    robot->move();
    robot->move();
    robot->turnRight(); // vira p/ a saída
    robot->move();
    robot->move();
    robot->faceSouth();
    robot->move();
    ...
    robot->move();
    robot->faceNorth();
    robot->move(); // chega onde precisa despejar 2 marcadores
    robot->putBeeper();
    robot->putBeeper();
    robot->move();
    robot->move();
