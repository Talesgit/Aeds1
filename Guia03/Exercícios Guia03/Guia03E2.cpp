...
*/
    ...
    */
    ...
    /// @brief
    /// @param n
    void pickBeepers(int beepers = 1)
    {
        while (beepers > 0)
        {
            pickBeeper();
...
int main()
{
    ...
    set_Speed(1.5);              // definir velocidade padrao
                                 // criar robo
    MyRobot *robot = new MyRobot();
    // posicionar robo no ambiente (situacao inicial):
    // posicao(x=1,y=1), voltado para direita, com zero marcadores, nome escolhido )
    MyRobot *robot2 = new MyRobot();
    robot->create(9, 5, EAST, 0, "Karel");
    robot2->create(2, 6, EAST, 0, "Jarel");
